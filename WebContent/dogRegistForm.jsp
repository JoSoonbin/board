...
<body>
	<div class="container" style = "width: 740px;">
		<h2>개정보등록</h2>
		<form action="dogRegist.dog" class="form-horizontal" method="post" name="writeForm" enctype="multipart/form-data">
			<div class="form-group">
				<label for="kind">품종 : </label>
				<div class="col-sm-10">
				<input type="text" name="kind" id="kind" required="required" class="form-control" placeholder="Enter email"/>
				</div>
			</div>
			<div class="form-group">
