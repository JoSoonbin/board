...
<body>
	...
	<div class="container" style="margin-top: 100px; width: 740px;">
			...
			<form method="post">
				<table class="table table-condensed">
					<tbody>
						...
						<tr
							style="font-size: 14px; font-weight: bold; background-color: #eeeeee;">
		...
		<button type="button" class="btn btn-default" onclick="location.href='dogList.dog'"
		style = "display: block; margin: 0 auto;">쇼핑 계속하기</button>
	</div>
</body>
</html>
